...
export LD_LIBRARY_PATH=/home/username/anaconda3/lib:/usr/local/cuda-8.0/cudnn_v51/lib64:/usr/local/cuda-8.0/lib64:/home/username/anaconda2/lib:$LD_LIBRARY_PATH
TOOLS=../../build/tools
data_root="/home/username/Desktop/3Dpose_ssl/data/h36m/gt/test/"
phase=test
num_action=15
...
do
  ...
  ../caffe-3dssl/build/tools/caffe test -gpu=0 -model=$tmp_proto_fn_2 \
  -weights=$model_fn \
