This folder provides the code being modified and tools to run custom data for 3Dpose_ssl, you will need the model provided/trained from [3Dpose_ssl](https://github.com/chanyn/3Dpose_ssl)
