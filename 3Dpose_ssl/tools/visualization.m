...
root_refine = '../tensorflow/srr_results/';
...
for folder_i = 1:1
    ...
    file = strcat('0.00015mpjp_',action_id,'.txt'); % refine 3dpose mpjp eval
    ...
    coarse3d_tmp = csvread([root_coarse3d,'result', action_id, '_unnorm.csv']);
